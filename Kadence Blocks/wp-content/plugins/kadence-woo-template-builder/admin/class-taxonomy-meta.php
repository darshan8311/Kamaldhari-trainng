...
class Kadence_Taxonomy_Meta {
	...
	function admin_enqueue_scripts()
	{
		...
		wp_enqueue_media();
		wp_register_script('kad_term_js', KADENCE_WOO_TEMPLATE_URL . 'js/min/kt_term_scripts-min.js', false, KADENCE_WOO_TEMPLATE_VERSION, false);
